...
def get_mocap_data(IPCDNNwalk_root):


    mocap_path_walk = IPCDNNwalk_root/"gym_trackSRB/motiondata_mujoco_refined/walk1_subject5.txt"
...
IPCDNNwalk_root= Path.home() / '.cache/IPCDNNwalk'
xmlpath=IPCDNNwalk_root/'gym_trackSRB/Characters/humanoid_deepmimic_withpalm_Tpose.xml'
...
sim=control.MujocoSim(str(xmlpath))
...
mocap_data = lua.mat(get_mocap_data(IPCDNNwalk_root)) # motiondof
